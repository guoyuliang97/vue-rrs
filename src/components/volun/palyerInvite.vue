        ...
        <div style="margin-top:17px">
          <div v-for="(item,index) in palyerList" :key="index" style="padding:18px 0;border-bottom: 1px solid #E8E8E8">
            ...
            <div style="display: flex;justify-content: space-between">
              <div>
                <LoadingImg type="3" v-on:toPublish="toPublish(item,index)" :src="item.cover.domain + item.cover.image_url" style="width:200px;height:135px;overflow: hidden;cursor: pointer" ></LoadingImg>
              </div>
              <div style="width:750px;font-size:12px;line-height:30px;">
                ...
                <div style="margin-top:26px;">
                  ...
                  <span style="color:#008489;margin-left:10px;">邀请志愿时间：<span v-for="(items,indexs) in item.slot">{{items.begin_time +'—'+items.end_time}}，</span></span>
                </div>
              </div>

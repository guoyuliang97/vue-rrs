<template>
	<div>
		...
		<div class="edit_con">
			<div class="edit_nav">
				<div class="edit_navdetail" @click="toEditdata" :style="{color:navIndex=='0'?'#14C5CA':'rgb(118, 118, 118)',fontWeight:navIndex=='0'?'bold':'normal'}">编辑个人资料</div>
				<div class="edit_navdetail" @click="toEditphoto" :style="{color:navIndex=='1'?'#14C5CA':'rgb(118, 118, 118)',fontWeight:navIndex=='1'?'bold':'normal'}">照片</div>
				<div class="edit_navdetail" @click="toEditcheck" :style="{color:navIndex=='2'?'#14C5CA':'rgb(118, 118, 118)',fontWeight:navIndex=='2'?'bold':'normal'}">信任与验证</div>
